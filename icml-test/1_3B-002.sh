...
# ------------------ Output Args ------------------ #
CHECKPOINT_PATH=/N/scratch/jindjia/checkpoints/icml/1_3B-1bitGrad-4bitWdiff-DUO/checkpoints
CHECKPOINT_SAVING_INTERVAL=5002
WANDB_PROJECT_NAME=ICML
WANDB_EXP_NAME=1_3B-1bitGrad-4bitWdiff-DUO
WANDB_DIR=/tmp/1_3B-1bitGrad-4bitWdiff-DUO/wandb
TENSORBOARD_DIR=/tmp/1_3B-1bitGrad-4bitWdiff-DUO/tensorboard
