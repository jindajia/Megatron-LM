...
# ------------------ Output Args ------------------ #
CHECKPOINT_PATH=/N/scratch/jindjia/checkpoints/icml/350M-1bitGrad-4bitWdiff/checkpoints
CHECKPOINT_SAVING_INTERVAL=5002
WANDB_PROJECT_NAME=ICML
WANDB_EXP_NAME=350M-1bitGrad-4bitWdiff
WANDB_DIR=/tmp/350M-1bitGrad-4bitWdiff/wandb
TENSORBOARD_DIR=/tmp/350M-1bitGrad-4bitWdiff/tensorboard
