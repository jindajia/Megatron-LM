...
export EXIT_INTERVAL=80000
export WANDB_PROJECT=icml-accuracy-test
export SCRIPT_DIR=/N/slate/jindjia/bash_scripts/bytedance2/icml-performance-bytedance
export OUTPUT_BASE_DIR=/N/slate/jindjia/bash_scripts/bytedance2/icml-accuracy-bytedance/tasks/2xA100Nodes/output_dir-acc32-setting2
