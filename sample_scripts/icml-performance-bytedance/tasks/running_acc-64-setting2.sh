...
export OUTPUT_BASE_DIR=/N/slate/jindjia/bash_scripts/bytedance2/icml-performance-bytedance/tasks/2xA100Nodes/output_dir-acc64-setting2
...
for num_nodes in "${NUM_NODES_LIST[@]}"; do
    ...
    for model in "${MODEL_LIST[@]}"; do
        ...
        for train_confit_name in "${TRAIN_CONFIG_LIST[@]}"; do
            ...
            export MODEL_ARG_PATH=${SCRIPT_DIR}/model-cards-2/${MODEL_NAME}.sh
